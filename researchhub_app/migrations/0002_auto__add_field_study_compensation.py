...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('researchhub_app_study', 'compensation',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('researchhub_app_study', 'compensation')
    ...
    models = {
        ...
        'researchhub_app.study': {
            'Meta': {'ordering': "('-created',)", 'object_name': 'Study'},
            'additional_criteria': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'compensation': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '8', 'decimal_places': '2', 'blank': 'True'}),
